"""reparmetrize yolov7E6E model, this repository will contain script to reparameterize the 
yolov7E6E version. 

The script needs model file and a configuration file for yolov7E6E
"""
...
def model_yolov7E6E(model_file, model_config_file, save_reparametrized_model = ""):
    """convert yolov7E6E model to reparametrize model for deployment purposes
       and save the resultant model to a specified directory..

    Args:
        model_file: str -> yolov7E6E trained model file path 
        model_config_file: str -> yolov7E6E config file path (i.e. yolov7E6E.yaml) in deploy directory 

"""reparmetrize yolov7D6 model, this repository will contain script to reparameterize the 
yolov7D6 version. 

The script needs model file and a configuration file for yolov7D6
"""
...
def model_yolov7D6(model_file, model_config_file, save_reparametrized_model = ""):
    """convert yolov7D6 model to reparametrize model for deployment purposes
       and save the resultant model to a specified directory..

    Args:
        model_file: str -> yolov7D6 trained model file path 
        model_config_file: str -> yolov7D6 config file path (i.e. yolov7D6.yaml) in deploy directory 
